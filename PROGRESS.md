...
- **Mid-game data loss prevention:** Game state auto-saved to localStorage every move (`aurorachess-game-{id}`). `beforeunload` handler as backup. InProgressGame interface in offlineSync.ts.
