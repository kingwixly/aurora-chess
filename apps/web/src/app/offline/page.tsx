  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen p-4 text-center">
      ...
      <div className="flex flex-col gap-3">
        <Link
          href="/play/bot"
          className="px-6 py-2 bg-emerald-500 hover:bg-emerald-400 rounded font-medium transition-colors"
        >
          Play vs Bot (Offline)
        </Link>
        <button
          onClick={() => window.location.reload()}
          className="px-6 py-2 bg-night-800 hover:bg-night-700 rounded font-medium transition-colors"
        >
          Try Again
        </button>
      </div>
