  ...
  return (
    <main className="flex flex-col items-center min-h-screen p-4 pt-12">
      <div className="max-w-3xl w-full prose prose-invert">
        ...
        <p>
          AuroraChess (&quot;we,&quot; &quot;our,&quot; or &quot;the Platform&quot;) is a
        ...
        <p>
          By creating an account and using AuroraChess, you acknowledge that you have read and
        ...
        <p>
          AuroraChess is a self-hosted platform. Your data is not shared with any third parties. The
        ...
        <h2>10. Children</h2>
        <p>
          AuroraChess does not knowingly collect data from children under 13. If you believe a child
        ...
        <div className="mt-8 text-center">
          <Link href="/legal/terms" className="text-aurora-cyan hover:underline">
