  ...
  return (
    <main className="flex flex-col items-center min-h-screen p-4 pt-12">
      <div className="max-w-3xl w-full prose prose-invert">
        ...
        <p className="text-sm text-night-400">Last updated: March 2026</p>

        <h2>1. Acceptance of Terms</h2>
        <p>
          By creating an account on AuroraChess (&quot;the Platform&quot;), you agree to be bound by
          ...
          AuroraChess instance (&quot;we,&quot; &quot;us,&quot; or &quot;our&quot;).
        </p>

        <h2>2. Eligibility</h2>
        <p>
          You must be at least 13 years of age to use the Platform. By using AuroraChess, you
        ...
        <p>
          5.1. AuroraChess uses an Elo rating system. You agree to play all rated games to the best
        ...
        <p>
          5.3. We reserve the right to analyse games for evidence of engine use and to take action
          including rating adjustments, temporary suspensions, or permanent bans.
        </p>

        <h2>6. Intellectual Property</h2>
        <p>
          6.1. AuroraChess is open source software licensed under the MIT License. The source code
          is available at the project&apos;s repository.
        </p>
        <p>
        ...
        <p>
          8.1. AuroraChess is provided on an &quot;as is&quot; and &quot;as available&quot; basis.
        ...
        <p>
          AuroraChess is open source software. The source code is available under the MIT License.
        ...
        <h2>18. Contact</h2>
        <p>
          For questions about these Terms of Service, contact the administrator of this AuroraChess
          instance.
        </p>

        <div className="mt-8 text-center">
          <Link href="/legal/privacy" className="text-aurora-cyan hover:underline">
            &larr; Privacy Policy
          </Link>
        </div>
      </div>
