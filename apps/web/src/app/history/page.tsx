  ...
  return (
    <main className="flex flex-col items-center min-h-screen p-4 pt-12">
      <div className="max-w-2xl w-full space-y-4">
        <h1 className="text-2xl font-bold text-center font-display">Game History</h1>
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 shrink-0 ml-2">
                      ...
                      <Link
                        ...
                        className="px-3 py-1 bg-night-800 hover:bg-night-700 rounded text-xs font-medium transition-colors"
                      >
                        Analyse
                      </Link>
                    </div>
            ...
            {totalPages > 1 && (
              <div className="flex items-center justify-center gap-2">
                <button
                  ...
                  disabled={page === 1}
                  className="px-3 py-1 bg-night-800 hover:bg-night-700 disabled:opacity-50 rounded text-sm"
                >
                  Prev
                </button>
