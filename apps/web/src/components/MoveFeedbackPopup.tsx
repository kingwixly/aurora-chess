...
const LABELS: Record<string, { text: string; color: string }> = {
  ...
  GREAT: { text: "Great Move!", color: "text-aurora-cyan" },
  BEST: { text: "Best Move", color: "text-emerald-400" },
  EXCELLENT: { text: "Excellent", color: "text-emerald-300" },
  GOOD: { text: "Good", color: "text-night-300" },
...
export default function MoveFeedbackPopup({ classification }: MoveFeedbackPopupProps) {
  ...
  return (
    <div
      className={`absolute top-4 left-1/2 -translate-x-1/2 z-20 px-4 py-2 rounded-lg bg-night-900/90 backdrop-blur pointer-events-none transition-all duration-300 ${
