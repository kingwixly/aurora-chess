    ...
    return (
      <main className="flex flex-col items-center justify-center min-h-screen p-4">
        <div className="max-w-md w-full text-center">
          <h1 className="text-2xl font-bold mb-4 font-display">Account Deactivated</h1>
  ...
  return (
    <main className="flex flex-col items-center min-h-screen p-4 pt-8">
      <div className="max-w-2xl w-full">
        ...
        <p className="text-night-400 text-center text-sm mb-6">
          Please read and accept our Terms of Service and Privacy Policy to continue using
          AuroraChess.
        </p>

        <div className="bg-night-900 rounded-lg p-6 mb-6 max-h-[60vh] overflow-y-auto text-sm text-night-300 space-y-4">
          <h2 className="text-lg font-bold text-white">Terms of Service</h2>
          <p>
            By using AuroraChess, you agree to be bound by these Terms of Service, our Privacy
          ...
          <p>
            Your data is not shared with third parties. AuroraChess does not use external analytics,
        ...
        <div className="flex gap-4">
          <button
            onClick={decline}
            className="flex-1 py-3 bg-night-800 hover:bg-night-700 rounded-lg font-medium transition-colors"
          >
            I Decline
          </button>
          <button
            onClick={accept}
            disabled={accepting}
            className="flex-1 py-3 bg-emerald-500 hover:bg-emerald-400 disabled:opacity-50 rounded-lg font-bold transition-colors"
          >
