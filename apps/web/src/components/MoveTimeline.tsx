...
export default function MoveTimeline({
  ...
  return (
    <div className="flex items-center gap-0.5 px-0.5 py-1 bg-night-900/80 rounded">
      <button
        onClick={() => onGoToPly(0)}
        disabled={currentPly === 0}
        className="px-1.5 py-0.5 text-night-400 hover:text-white disabled:text-night-300 text-sm shrink-0"
      >
        ⏮
      </button>
      <button
