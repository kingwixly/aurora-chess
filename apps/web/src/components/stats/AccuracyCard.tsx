  ...
  if (gamesAnalysed === 0) {
    return (
      <div className="bg-night-800 rounded-lg p-4">
        ...
        <p className="text-night-400 text-sm">No analysed games yet</p>
      </div>
    );
  }
    ...
    <div className="bg-night-800 rounded-lg p-4">
      ...
      <div className="grid grid-cols-3 gap-3 text-center">
        <div>
          ...
          <div className="text-xs text-night-400">Average</div>
        </div>
        <div>
          <div className="text-2xl font-bold text-emerald-400 font-display">{best?.value}%</div>
          <div className="text-xs text-night-400">Best</div>
        </div>
        <div>
          <div className="text-2xl font-bold text-red-400 font-display">{worst?.value}%</div>
          <div className="text-xs text-night-400">Worst</div>
        </div>
      </div>
      <div className="text-xs text-night-400 text-center mt-2">{gamesAnalysed} games analysed</div>
    </div>
  );
}
