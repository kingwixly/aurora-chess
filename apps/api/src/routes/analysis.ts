...
export async function analysisRoutes(app: FastifyInstance) {
  ...
  // Queue analysis job.
  //
  // Registered under both spellings: the client was moved to "analysis" by a
  // spelling sweep while the route stayed "analyze", which silently broke
  ...
  app.post<{ Params: { id: string } }>("/games/:id/analysis", queueAnalysis as never);
  app.post<{ Params: { id: string } }>("/games/:id/analyze", queueAnalysis as never);
