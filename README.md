<p align="center">
  <img src="logo.png" alt="AuroraChess" width="200">
</p>
<h1 align="center">AuroraChess</h1>
<p align="center">A fully self-hostable, open source chess platform.<br/>Play, analyze, and compete — on your own server.</p>

<p align="center">
  <a href="https://github.com/amiwrpremium/aurora-chess/actions/workflows/ci.yml"><img src="https://github.com/amiwrpremium/aurora-chess/actions/workflows/ci.yml/badge.svg" alt="CI"></a>
  <a href="https://github.com/amiwrpremium/aurora-chess/actions/workflows/security.yml"><img src="https://github.com/amiwrpremium/aurora-chess/actions/workflows/security.yml/badge.svg" alt="Security"></a>
  <a href="https://github.com/amiwrpremium/aurora-chess/actions/workflows/release.yml"><img src="https://github.com/amiwrpremium/aurora-chess/actions/workflows/release.yml/badge.svg" alt="Release"></a>
  <a href="https://app.codacy.com/gh/amiwrpremium/aurora-chess/dashboard?utm_source=gh&utm_medium=referral&utm_content=&utm_campaign=Badge_grade"><img src="https://app.codacy.com/project/badge/Grade/bec76f3311ba4634bb6456cbf9cc36b6" alt="Codacy Badge"></a>
  <a href="https://app.codacy.com/gh/amiwrpremium/aurora-chess/dashboard?utm_source=gh&utm_medium=referral&utm_content=&utm_campaign=Badge_coverage"><img src="https://app.codacy.com/project/badge/Coverage/bec76f3311ba4634bb6456cbf9cc36b6" alt="Codacy Coverage"></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/License-MIT-green.svg" alt="License: MIT"></a>
  <img src="https://img.shields.io/badge/node-%3E%3D22-339933?logo=node.js&logoColor=white" alt="Node.js >= 22">
  <a href="https://github.com/amiwrpremium/aurora-chess/commits/master"><img src="https://img.shields.io/github/last-commit/amiwrpremium/aurora-chess" alt="Last Commit"></a>
  <a href="https://github.com/amiwrpremium/aurora-chess/issues"><img src="https://img.shields.io/github/issues/amiwrpremium/aurora-chess" alt="Issues"></a>
  <a href="https://github.com/amiwrpremium/aurora-chess/pulls"><img src="https://img.shields.io/badge/PRs-welcome-brightgreen.svg" alt="PRs Welcome"></a>
  <img src="https://img.shields.io/github/repo-size/amiwrpremium/aurora-chess" alt="Repo Size">
  <img src="https://img.shields.io/github/languages/top/amiwrpremium/aurora-chess" alt="Top Language">
  <a href="https://github.com/amiwrpremium/aurora-chess/stargazers"><img src="https://img.shields.io/github/stars/amiwrpremium/aurora-chess?style=social" alt="Stars"></a>
</p>
...
```bash
git clone https://github.com/amiwrpremium/aurora-chess.git
cd aurora-chess
cp .env.example .env
...
| --------------------- | ------------------ | -------------------------------------- |
| `SITE_NAME`           | `AuroraChess`       | Display name (white-label)             |
...
| Variable             | Default                  | Description                       |
| -------------------- | ------------------------ | --------------------------------- |
| `SEED_USER_EMAIL`    | `admin@aurorachess.local` | Admin email                       |
...
# Restore
gunzip -c backups/aurorachess_YYYYMMDD_HHMMSS.sql.gz | \
  docker compose -f deployment/docker-compose.yml exec -T postgres psql -U postgres aurorachess
```
...
AuroraChess is an independent open source project. It is **not affiliated with, endorsed by, or associated with** Lichess, Chess.com, Stockfish, or any other chess platform or organization. All trademarks and product names are the property of their respective owners.
