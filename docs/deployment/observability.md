...
AuroraChess includes a full observability stack in the production Docker Compose setup.
...
### API Performance (`aurorachess-api-perf`)
...
| ---------------------------------- | ------- | ------------------------------ |
| `aurorachess_active_games`          | Gauge   | Currently active games         |
| `aurorachess_analysis_queue_depth`  | Gauge   | Jobs waiting in analysis queue |
| `aurorachess_total_users`           | Gauge   | Total registered users         |
| `aurorachess_games_completed_total` | Counter | Cumulative completed games     |
...
- **Grafana:** Persisted in `aurorachess-grafana-data` Docker volume
