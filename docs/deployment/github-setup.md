...
Comprehensive guide to configuring your GitHub repository for security, CI/CD, and best practices. Follow these steps after forking or creating your AuroraChess repository.
...
| `SITE_URL`        | `https://aurora-chess.com`          | Main site URL (baked into Docker images) |
| `ADMIN_URL`       | `https://admin.aurora-chess.com`    | Admin panel URL (baked into web image)   |
...
AuroraChess includes a `SECURITY.md` with:
