...
AuroraChess uses [Prisma Migrate](https://www.prisma.io/docs/concepts/components/prisma-migrate) for all schema changes.
...
```bash
cd apps/api
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/aurorachess \
