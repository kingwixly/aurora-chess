...
| --------------------- | ------------------------------------------------------------------------------------------------------ | --------------------------------------------------------- |
| `DATABASE_URL`        | PostgreSQL connection string. In Docker, points to PgBouncer for connection pooling.                   | `postgresql://postgres:postgres@postgres:5432/aurorachess` |
...
| Variable    | Description                                                          | Default            |
| ----------- | -------------------------------------------------------------------- | ------------------ |
| `SITE_NAME` | Display name for the platform. Supports white-labeling.              | `AuroraChess`       |
...
| Variable             | Description                                       | Default                  |
| -------------------- | ------------------------------------------------- | ------------------------ |
| `SEED_USER_EMAIL`    | Admin email                                       | `admin@aurorachess.local` |
